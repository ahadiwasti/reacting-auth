...
func SetUp(e *gin.Engine, cors bool) {
	...
	v1.POST("/userCreate", userController.Create)
	...
	// v1.GET("/devices", deviceController.List)
	// v1.POST("/devices", deviceController.Create)
	// v1.PUT("/devices/:id", deviceController.Edit)
	// v1.DELETE("/devices/:id", deviceController.Delete)
	//menu
	...
	// admin-service
	AmsController := &controllers.AmsController{}
	v1.POST("/amstech", AmsController.Amstech_rpc)
	v1.POST("/amstechevent", AmsController.Amstech_rpcevent)
	v1.POST("/uploadImage", AmsController.Amstech_upload)
	v1.POST("/uploadAPK", AmsController.Amstech_apk)
	v1.POST("/removeAPK", AmsController.Amstech_removeapk)
	v1.POST("/removeFile", AmsController.Amstech_remove)
	v1.POST("/uploadpemfile", AmsController.Amstech_pemfile)
	v1.POST("/removepemfile", AmsController.Amstech_removepemfile)
	v1.POST("/log/amslogs", AmsController.AMSlogs)
	v1.POST("/uploaddeliverynotes", AmsController.Amstech_deliverynotes)
	v1.POST("/removedeliverynotes", AmsController.Amstech_removedeliverynotes)
	v1.POST("/uploadrefundfile", AmsController.Amstech_uploadrefundfile)
	v1.POST("/removerefundfile", AmsController.Amstech_removerefundfile)
	// admin-ERP-service
	ERPController := &controllers.ERPController{}
	// v1.POST("/erpParser", ERPController.erpParserfunc)
	v1.POST("/axiomerp/get", ERPController.GetPO)
	v1.POST("/axiomerp/update", ERPController.UpdatePO)
}
